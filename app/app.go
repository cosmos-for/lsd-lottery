...
func New(
	...
	*/
	...
	app.LsdlotteryKeeper = *lsdlotterymodulekeeper.NewKeeper(
		appCodec,
		keys[lsdlotterymoduletypes.StoreKey],
		keys[lsdlotterymoduletypes.MemStoreKey],
		app.GetSubspace(lsdlotterymoduletypes.ModuleName),
	)
